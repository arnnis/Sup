...
export const signinTeamSuccess = (
  token: string,
  teamId: string,
  userId: string,
...
export const getTeamStart = (teamId: string) =>
  action('GET_TEAM_START', {teamId});
export const getTeamSuccess = (teamId: string) =>
  action('GET_TEAM_SUCCESS', {teamId});
export const getTeamFail = (teamId: string) =>
  action('GET_TEAM_FAIL', {teamId}, {teamId});

export const setCurrentTeam = (teamId: string) =>
  action('SET_CURRENT_TEAM', {teamId});
